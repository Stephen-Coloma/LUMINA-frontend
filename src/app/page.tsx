        ...
        <div className="container flex h-16 items-center space-x-4 sm:justify-between sm:space-x-0">
          ...
          <div className="flex flex-1 items-center justify-end space-x-4">
            ...
            <nav className="hidden md:flex items-center space-x-4">
              <Link
                href="/about"
                className="px-3 py-2 text-sm font-medium text-muted-foreground transition-colors hover:text-lumina-600 hover:bg-lumina-50 rounded-md"
              >
                About
              </Link>
              <Link
              ...
              <Button
                variant="default"
                size="sm"
                className="bg-lumina-600 hover:bg-lumina-700 px-4"
            ...
            {/* Mobile Menu Button */}
            <button
              className="md:hidden p-2 rounded-md text-muted-foreground hover:text-lumina-600 hover:bg-lumina-50"
        ...
        {mobileMenuOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 border-t">
              <Link
                href="/about"
                className="block px-3 py-2 rounded-md text-base font-medium text-muted-foreground hover:text-lumina-600 hover:bg-lumina-50"
              ...
              <div className="pt-2">
                <Button
                  variant="default"
                  className="w-full bg-lumina-600 hover:bg-lumina-700"
                  onClick={handleGetStarted}
                >
                  Get Started
                </Button>
            ...
            <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
              <div className="flex flex-col justify-center space-y-4">
                ...
                <div className="flex flex-col gap-2">
                  <Button className="w-full bg-lumina-600 hover:bg-lumina-700" onClick={handleScanAnalysis}>
                    Start Scan Analysis
          ...
          <div className="container px-4 md:px-6">
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12">
              ...
              <div className="flex flex-col justify-center space-y-4">
                ...
                <div className="flex flex-col gap-2 min-[400px]:flex-row">
                  <Button className="w-full bg-lumina-600 hover:bg-lumina-700" onClick={handleSymptomAnalysis}>
                    Enter Symptoms
